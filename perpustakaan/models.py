...
class Kelompok(models.Model):
    ...
    # return self.nama ini utk menampilkan apa di kelompok id django admin
    def __str__(self):
        return self.nama
...
class Buku(models.Model):
    ...
    # arti on_delete disini untuk jika menghapus satu, maka akan terhapus di tabel lainnya
